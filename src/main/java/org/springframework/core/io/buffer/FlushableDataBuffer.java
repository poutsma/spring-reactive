...
/**
 * {@link DataBuffer} wrapper to make it flushable.
 *
 * @author Sebastien Deleuze
 */
public class FlushableDataBuffer implements DataBuffer, Flushable {

	private final DataBuffer buffer;

	public FlushableDataBuffer(DataBuffer buffer) {
		this.buffer = buffer;
	}
